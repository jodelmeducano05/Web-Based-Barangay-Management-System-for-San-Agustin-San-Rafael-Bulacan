...
export default function App() {
  ...
  const [announcements, setAnnouncements] = useState([
    {
      ...
      description:
        "All residents are invited to attend the barangay general assembly at Brgy Hall of SAN AGUSTIN.",
    },
    {
      id: 2,
      ...
      description:
        "Community clean-up drive will be held at the covered court of SAN AGUSTIN.",
    },
    {
      id: 3,
      ...
      description:
        "Free medical check-up for residents of SAN AGUSTIN.",
    },
  ]);
  ...
  const handleModuleSelect = (modName) => {
    ...
    if (user.role !== modRole) {
      showToast(
        `⛔ ACCESS DENIED: ${user.role} ka lang. Hindi mo pwedeng buksan ang ${modRole} Dashboard!`
      );
      return;
    }
...
function Login({
  ...
  const handleSignup = () => {
    if (
      ...
      return showToast("Kumpletuhin ang form");
    }
    ...
    if (
      signupData.role === "Captain" ||
      signupData.role === "Secretary"
    ) {
      const requiredCode = ROLE_CODES[signupData.role];

      if (!signupData.accessCode) {
        return showToast(
          `Kailangan ng Access Code para sa ${signupData.role}!`
        );
      }

      if (signupData.accessCode !== requiredCode) {
        return showToast(
          `⛔ Mali ang Access Code para sa ${signupData.role}!`
        );
      }
    }
          ...
          >
            ...
            {(signupData.role === "Captain" ||
              ...
              >
                ...
                >
                  🔒 Access Code for {signupData.role}
                </label>
                ...
                <div style={styles.passwordWrapper}>
                  <input
                    ...
                    placeholder={`Enter code for ${signupData.role}`}
                    type={
                ...
                >
                  Hingin ang code sa admin. Resident = no code.
                </p>
              </div>
            )}
  ...
  const modules = [
    {
      ...
      description:
        "Nag-request ng documents at tumitingin ng sariling impormasyon at request status.",
    },
    {
      ...
      description:
        "Nag-aapprove at nagre-review ng mga report at request.",
    },
    {
      ...
      color: COLORS.primary,
      description:
        "Nag-eencode, nag-aayos, at nagpo-process ng mga records at documents.",
    },
  ];
    ...
    <div style={styles.modulePage}>
      ...
      <main style={styles.moduleContent}>
        <div style={styles.welcomeBox}>
          ...
          <p>
            Ikaw ay naka-login bilang <b>{user.role}</b>.
            Isang dashboard lang ang pwede mong buksan -
            {" "}
            {BARANGAY}
          </p>
        </div>
  ...
  return (
    <div style={styles.dashboardLayout}>
      ...
      <main style={styles.mainContent}>
        <header style={styles.dashboardTopbar}>
          <div>
            <p style={styles.breadcrumb}>
              Home / {activePage} / {BARANGAY}
            </p>
    ...
    <div>
      ...
      >
        <div>
          ...
          <p>
            {role === "Captain"
              ? "Ikaw ang mag-aapprove at magre-review ng reports - SAN AGUSTIN."
              : role === "Secretary"
              ? "Ikaw ang mag-eencode at magpo-process ng records - SAN AGUSTIN."
              : "Mag-request at i-track ang status ng documents mo - SAN AGUSTIN."}
            <br />
            You are using <strong>{selectedModule}</strong>
          </p>
        </div>
        ...
        <div style={styles.contentCard}>
          ...
          <div style={styles.quickActions}>
            ...
            >
              ...
              <span>
                {role === "Resident"
                  ? "View My Blotter Status"
                  : role === "Secretary"
                  ? "Encode / Process Blotter"
        ...
        <div style={styles.contentCard}>
          ...
          <div style={styles.activityList}>
            <div style={styles.activityItem}>
              ...
              <div>
                <strong>New document request</strong>
                ...
                >
                  Barangay Clearance - SAN AGUSTIN
                </p>
            ...
            <div style={styles.activityItem}>
              ...
              <div>
                ...
                >
                  {pendingDocs} Pending, {verifiedDocs} Verified
                </p>
...
function DocumentsPage({
  ...
  const handleSubmit = () => {
    if (!form.resident) {
      return showToast("Enter resident name");
    }
    ...
    showToast("Request Created - Pending for Secretary");
  };
  ...
  const handleStatusChange = (docId, newStatus) => {
    if (
      ...
      return showToast(
        "⛔ Secretary lang pwede mag Verified!"
      );
    }
    ...
    if (
      ...
      return showToast(
        "⛔ Captain lang pwede mag Approve/Reject!"
      );
    }
  ...
  return (
    <div>
      <div style={styles.pageHeader}>
        <div>
          <h2>Document Requests - {BARANGAY}</h2>

          <p>
            {role === "Resident"
              ? "Mag-request at tingnan ang status."
              : role === "Secretary"
              ? "Nag-eencode at nagpo-process ng documents."
              : "Nag-aapprove at nagre-review ng requests."}
          </p>
        </div>
      ...
      {showDetail && (
        ...
        >
          ...
          >
            <h3>
              {showDetail.id} - {BARANGAY}
            </h3>

            <p>
              <b>Resident:</b> {showDetail.resident}
            </p>
            ...
            >
              ...
              {role === "Secretary" &&
                showDetail.status !== "Pending" && (
                  <div style={styles.infoBox}>
                    Na-process mo na ito. Si Captain na
                    mag-approve.
                  </div>
                )}
              ...
              {role === "Captain" &&
                showDetail.status === "Pending" && (
                  <div style={styles.infoBoxError}>
                    ⛔ Hintayin ma-verify ni Secretary
                    muna.
                  </div>
                )}
              ...
              {role === "Resident" && (
                <div style={styles.infoBox}>
                  ...
                  Antayin si Secretary at Captain.
                </div>
              )}
...
function BlotterReportsPage({
  ...
  const handleSubmit = () => {
    if (!form.complainant) {
      return showToast("Enter complainant");
    }
    ...
    const newB = {
      ...
      incident:
        form.incident || "General Complaint",
      date: new Date().toLocaleDateString(),
      status: "Pending",
    };
    ...
    showToast(`Blotter ${newB.id} filed`);
  };
  ...
  const handleBlotterStatus = (id, newStatus) => {
    if (
      ...
      return showToast(
        "⛔ Si Secretary lang pwede mag-process!"
      );
    }
    ...
    if (
      ...
      return showToast(
        "⛔ Si Captain lang pwede mag-resolve!"
      );
    }
  ...
  return (
    <div>
      <div style={styles.pageHeader}>
        <div>
          <h2>Blotter Reports - {BARANGAY}</h2>

          <p>
            {role === "Resident"
              ? "Tumitingin ng sariling report status."
              : role === "Secretary"
              ? "Nag-eencode at nagpo-process ng blotter."
              : "Nag-aapprove at nagre-review ng mga report."}
          </p>
        </div>
      ...
      {detail && (
        ...
        >
          ...
          >
            ...
            <p>
              <b>Complainant:</b> {detail.complainant}
            </p>

            <p>
              <b>Incident:</b> {detail.incident}
            </p>
            ...
            >
              ...
              {role === "Secretary" &&
                ...
                detail.status !== "Dismissed" && (
                  <div style={styles.infoBox}>
                    Na-process mo na. Si Captain na
                    magre-review.
                  </div>
                )}
              ...
              {role === "Resident" && (
                <div style={styles.infoBox}>
                  View only - {detail.status}. Si
                  Secretary mag-process, si Captain
                  mag-approve.
                </div>
              )}
...
function AnnouncementsPage({
  ...
  const canManage =
    role === "Captain" || role === "Secretary";

  const handlePost = () => {
    if (!form.title) {
      return showToast("Enter title");
    }
    ...
    <div>
      ...
      {showForm && canManage && (
        <div style={styles.formCard}>
          ...
          <textarea
            style={styles.textarea}
            placeholder="Details - SAN AGUSTIN"
            value={form.description}
            onChange={(e) =>
              setForm({
                ...form,
