        ...
        <div style={styles.modalOverlay} onClick={() => setShowSignup(false)}>
          <div style={styles.modal} onClick={e=>e.stopPropagation()}>
            ...
            <div style={styles.passwordWrapper}>
              ...
              />
              <button type="button" style={styles.eyeButton} onClick={() => setShowSignupPassword(!showSignupPassword)}>
            ...
            {(signupData.role === "Captain" || signupData.role === "Secretary") && (
              <div style={{background:'#fef9c3', padding:'10px', borderRadius:'8px', border:'1px solid #fde047', marginBottom:'12px'}}>
                ...
                <div style={styles.passwordWrapper}>
                  <input 
                    style={{...styles.input, borderColor:'#eab308', marginBottom:'5px', paddingRight:'45px'}} 
                  ...
                  />
                  <button type="button" style={{...styles.eyeButton, top:'7px'}} onClick={() => setShowAccessCode(!showAccessCode)}>
                    {showAccessCode ? "🙈" : "👁️"}
                  </button>
                </div>
...
// ... yung DashboardModules, DashboardLayout, DashboardHome, DocumentsPage, BlotterReportsPage, AnnouncementsPage same lang as before ...
...
const styles = {
  ...
  // --- BAGO: Eye button styles ---
  passwordWrapper: { position:"relative", display:"flex", alignItems:"center", width:"100%", marginBottom:"16px" },
  eyeButton: { position:"absolute", right:"12px", background:"none", border:"none", cursor:"pointer", fontSize:"18px", lineHeight:1, padding:"4px" },
  // --- END BAGO ---
